...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav className={`h-16 absolute top-0 left-0 w-full z-50 flex items-center ${appState === AppState.WORKSPACE ? 'justify-end' : 'justify-between'} px-2 md:px-6 lg:px-8 transition-all duration-300 border-b border-white/5 ${appState === AppState.WORKSPACE ? 'bg-black' : 'bg-transparent backdrop-blur-sm'}`}>
